        ...
        <div className="our-projects-individual-containers">
          <div className="project-textAll">
            ...
            <p>
              ...
              <br></br>
              <p style={{ fontSize: 14 }}>
                ⚙️ Tech: Figma, React Native and GitHub.
              </p>
            </p>
        ...
        <div className="our-projects-individual-containers">
          <div className="project-textAll">
            ...
            <p>
              ...
              <br></br>
              <p style={{ fontSize: 14 }}>
                ⚙️ Tech: MongoDB, Javascript, Jest, Cypress, HTML, CSS,
                Git, and GitHub.
              </p>
            </p>
        ...
        <div className="our-projects-individual-containers">
          <div className="project-textAll">
            ...
            <p>
              ...
              <br></br>
              <p style={{ fontSize: 14 }}>
                ⚙️ Tech: React, Javascript, HTML, CSS, Chat GPT, Figma,
                Git, and GitHub.
              </p>
            </p>
          </div>
        ...
        <div className="our-projects-individual-containers">
          <div className="project-textAll">
            ...
            <p>
              ...
              <br></br>
              <p style={{ fontSize: 14 }}>
                ⚙️ Tech: Git, GitHub, JavaScript, React, Cypress, CSS and
                HTML.
              </p>
            </p>
